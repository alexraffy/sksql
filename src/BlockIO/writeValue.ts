 ...
 */
export function writeValue(table: ITable, tableDef: ITableDefinition, column: TableColumn, fullRow: DataView, value: string | number | boolean | bigint | numeric, extraOffset: number = 5) {
